(function () {
  ...
  function sortTable(button) {
    ...
    rows.sort(function (left, right) {
      var result = compareSortValues(cellSortValue(left, column), cellSortValue(right, column));
  ...
  function updateRecordDrawerSupplementalPanels(explorer, row, drawer, details) {
    ...
    appendRecordDrawerList(history, preferredRecordFields(fields, ['Last Seen', 'Last Scan', 'Cert Expiry', 'Status', 'Uptime (%)', 'Agent Version']));

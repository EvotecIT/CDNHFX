  function init() {
    ...
    document.querySelectorAll('[data-hfx-monitoring-search-scope]').forEach(applyFilters);
    document.querySelectorAll('[data-hfx-monitoring-record-explorer]').forEach(updateColumnPickerSummary);
    document.querySelectorAll('[data-hfx-monitoring-record-explorer]').forEach(observeRecordDrawerHeight);

  ...
  function resetRecordTableHorizontalPosition(explorer) {
    var scroller = explorer ? explorer.querySelector('.hfx-monitoring-table-wrap') : null;
    if (!scroller) return;
  ...
  function applyColumnState(explorer, keys) {
    ...
    resetRecordTableHorizontalPosition(explorer);
  }
  ...
  function activateTab(tab) {
    ...
    tabset.querySelectorAll('[data-hfx-monitoring-tab-panel]').forEach(function (panel) {
      if (panel.closest('[data-hfx-monitoring-tabset]') !== tabset) return;

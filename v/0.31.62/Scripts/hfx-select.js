document.addEventListener('DOMContentLoaded', function () {
  ...
  sels.forEach(function (el) {
    ...
    try {
      var options = {
        // An explicitly supplied empty option is a selectable value, not just placeholder text.
        allowEmptyOption: Array.prototype.some.call(el.options, function (option) { return option.value === ''; }),
        render: {
